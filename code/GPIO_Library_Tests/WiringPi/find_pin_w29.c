/*
This program attempts to find which pin is currently connected to pin w29.
To run this program, connect another GPIO pin through a resistor to pin w29 (40/21).
Then run the program and it should report which pin (or pins) are connected to w29.
